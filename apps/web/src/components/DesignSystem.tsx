...
import type { StatusDomain, StatusDomainMap, UserRole } from '@rentar/shared-types'
import {
  ActivityTimeline,
  AppShell,
  AuthLayout,
...
import { navConfigByRole } from '@/lib/navConfig'
...
const semanticColors: SemanticSwatch[] = [
  ...
  { name: 'Info', hex: '#004D98', text: '#ffffff', usage: 'alquilada, finalizado — reusa el azul de marca.' },
  { name: 'Neutral', hex: 'rgba(18,32,46,0.5)', text: '#ffffff', usage: 'borrador, anulado, cerrado, cancelada.' },
...
const ROLE_SWITCHER_OPTIONS: { label: string; value: UserRole }[] = [
...
export default function DesignSystem() {
  ...
  const [demoRole, setDemoRole] = useState<UserRole>('locador')
          ...
          <main className={styles.content}>
            ...
            <section id="estados" className={styles.section}>
              ...
              <div className={styles.grid2}>
                <StatusGroup domain="propiedad" label="Propiedad" statuses={['borrador', 'publicada', 'pausada', 'alquilada']} />
                <StatusGroup
                  domain="contrato"
                  label="Contrato"
                  statuses={['borrador', 'pendiente_firma', 'vigente', 'finalizado', 'rescindido']}
                />
                <StatusGroup domain="firma" label="Firma" statuses={['pendiente', 'firmado', 'rechazado']} />
                <StatusGroup domain="cobro" label="Cobro" statuses={['pendiente', 'pagado', 'vencido', 'anulado']} />
            ...
            <section id="layouts" className={styles.section}>
              ...
              <Segmented
                value={demoRole}
                onChange={(value) => setDemoRole(value as UserRole)}
              ...
              <div className={styles.liveFrame}>
                ...
                <div className={styles.appShellFrame}>
                  <AppShell
                    compact
                    navItems={navConfigByRole[demoRole]}
                    activeKey={navConfigByRole[demoRole][0]?.key ?? ''}
                    user={{ name: 'Nico A', role: demoRole }}
            ...
            <section id="feedback" className={styles.section}>
              ...
              <div className={styles.componentStack}>
                ...
                <div className={styles.inlineDemoRow}>
                  ...
                  <UserMenu name="Nico A" role="locador" />
                </div>
              </div>

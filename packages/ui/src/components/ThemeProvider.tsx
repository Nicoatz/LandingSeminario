 ...
 * particular, las previews aisladas que arma /design-sync (Claude Design),
 * que no pasan por `layout.tsx` y de otro modo renderizarían con el tema
 * default de antd en vez del de marca.
 */
